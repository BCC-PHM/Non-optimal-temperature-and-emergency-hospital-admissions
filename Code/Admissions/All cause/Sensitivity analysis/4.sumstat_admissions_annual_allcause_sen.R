...
admsenfreqplot <- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean, weight = total)) +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig1_admsenfreqplot_sen.svg", width=7, height=2) # save to files

# 0-4

admsenfreqplota04 <- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean, weight = a04)) +
  geom_histogram(binwidth = 1, fill = "grey", colour = "black") +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig2_admsenfreqplota04_sen.svg", width=7, height=2) # save to files

# 5-14

admsenfreqplota514 <- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean, weight = a514)) +
  geom_histogram(binwidth = 1, fill = "grey", colour = "black") +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig3_admsenfreqplota514_sen.svg", width=7, height=2) # save to files

# 15-64

admsenfreqplota1564<- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean, weight = a1564)) +
  geom_histogram(binwidth = 1, fill = "grey", colour = "black") +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig4_admsenfreqplota1564_sen.svg", width=7, height=2) # save to files

# 65-74

admsenfreqplota6574<- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean, weight = a6574)) +
  geom_histogram(binwidth = 1, fill = "grey", colour = "black") +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig5_admsenfreqplota6574_sen.svg", width=7, height=2) # save to files

# 75+

admsenfreqplota75 <- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean, weight = a75plus)) +
  geom_histogram(binwidth = 1, fill = "grey", colour = "black") +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig6_admsenfreqplota75_sen.svg", width=7, height=2) # save to files


# b) All cause admissions over time by age group - keeping to demonstrate Covid impact

# Create age group column (pivot)
data_adm_allcause_sen_aggr_agegroup <- data_adm_allcause_sen_aggr %>%
...
ggplot(data_adm_allcause_sen_aggr_agegroup,
...
# Save the plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig7_total_monthly_adm_sen_agegroup_linechart.svg", width=10, height=5)

# 4.2 Exposure data

# a)  Admissions plot to determine frequency at different temperatures
tempfreqplot <- ggplot(data_adm_allcause_sen_aggr, aes(x = tasmean)) +
  geom_histogram(binwidth = 1, fill = "grey", colour = "black") +
...
# Save the  plot
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig8_tempfreqplot_sen.svg", width=7, height=2) # save to files
...
ggsave("Outputs/Admissions/All cause/Sensitivity analysis/1. Summary statistics/fig9_daily_mean_temp_linechart_sen.svg", width=10, height=3)

#Remove files and data not required
rm(dailypm25,daily_temp_aggr,daily_temp_LSOA,data_adm_allcause_sen_aggr_agegroup) # remove data tables not required
