...
# Save the plot
dev.print(svg, file="Outputs/Deaths/All cause/Main/3. Main model (DLNM)/fig32_allcausedeaths_main_ctsaggr04_plot.svg", width=7, height=4)
...
# Save the plot
dev.print(svg, file="Outputs/Deaths/All cause/Main/3. Main model (DLNM)/fig33_allcausedeaths_main_ctsaggrd514_plot.svg", width=7, height=4)
...
# Save the plot
dev.print(svg, file="Outputs/Deaths/All cause/Main/3. Main model (DLNM)/fig34_allcausedeaths_main_ctsaggr1564_plot.svg", width=7, height=4)
...
# Save the plot
dev.print(svg, file="Outputs/Deaths/All cause/Main/3. Main model (DLNM)/fig35_allcausedeaths_main_ctsaggr6574_plot.svg", width=7, height=4)
...
# Save the plot
dev.print(svg, file="Outputs/Deaths/All cause/Main/3. Main model (DLNM)/fig36_allcausedeaths_main_ctsaggr75_plot.svg", width=7, height=4)
